...
warning off % nchoosek (line 92)  
%% Compare generalization error bounds
Nd=100; 
SN=95;
N_discard=5;
bet=10^-6;
...
N_train=500; % available scenarios (for training the IPM)
N_test= 10^4; % scenarios for testing
% Generate samples  
